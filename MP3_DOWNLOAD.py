# Arquivo: MP3_Download.py
# Autor: Rogério Nascimento
# Descrição: Este é um script Python simples para baixar arquivos de audio do Youtube


#Importando os pacotes que iremos utilizar. Não esqueça de importar todas elas.
...
# Caminho relativo para utilizar pyinstaller --one-file -- mais especificamente: pyinstaller --onefile -w MP3_DOWNLOAD.py

# Não esqueça de instalar os pacotes: customtkinter, yt-dlp, pyperclip. 
